      ...
      >
        <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16 lg:h-20">
            ...
            {/* Logo — secret admin access on click */}
            <Link
              href="/admin/login"
            ...
            <div className="flex lg:hidden items-center gap-2">
              <Button variant="primary" size="sm" href="/order" className="text-xs px-3 py-2">
        ...
        >
          <div className="bg-cream border-t border-soft-pink px-4 pb-6 pt-4 flex flex-col gap-4">
            ...
            {/* CTA Button */}
            <div className="pt-2 border-t border-soft-pink">
              <Button variant="primary" size="md" href="/order" className="w-full justify-center">
                <ShoppingCart size={16} />
                Order Now
              </Button>
            </div>
